	...
	<div class="space-y-2">
		<div class="flex justify-between items-center">
			...
			<button
				@click="triggerPaste"
				:class="[
					'inline-flex items-center px-2.5 py-1.5 text-xs font-medium rounded transition-colors duration-200 ease-in-out bg-gray-100 text-gray-700 hover:bg-gray-200'
				]"
				type="button"
			>
		...
		>
			...
			<div v-else class="text-center py-12">
				...
				<p class="text-xs text-gray-500 mt-1">Supports PNG, JPG, GIF</p>
			</div>
		</div>
...
import { Upload, X, Image as ImageIcon, ClipboardPaste } from 'lucide-vue-next';
